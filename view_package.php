...
<head>
    ...
    <title>VoLTE Package Details</title>
    
    <style>
    .gradient-background {
        background: linear-gradient(90deg, #C6E2FF, #FFD6E8); /* Soft Blue to Light Pink */
    }
    </style>

</head>
<body>
<section class="page-section gradient-background">
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                ...
                <div class="w-100">
                    ...
                    <div class="w-100 d-flex justify-content-between">
                        <span class="rounded-0 btn-flat btn-sm btn-primary d-flex align-items-center  justify-content-between"> <span class="ml-1">₹ <?php echo number_format($cost) ?></span></span>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('book').addEventListener('click', function() {
            if("<?php echo $_settings->userdata('id') ?>" > 0)
                uni_modal("Booking","book_form.php?package_id=<?php echo $id ?>");
            else
